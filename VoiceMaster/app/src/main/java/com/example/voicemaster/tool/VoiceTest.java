 ...
 * 语音评测demo
 */
public class VoiceTest extends Activity implements OnClickListener {
	private static String TAG = VoiceTest.class.getSimpleName();
	...
	private void initUI() {
		findViewById(R.id.image_ise_set).setOnClickListener(VoiceTest.this);
		...
		mIseStartButton.setOnClickListener(VoiceTest.this);
		findViewById(R.id.ise_parse).setOnClickListener(VoiceTest.this);
		findViewById(R.id.ise_stop).setOnClickListener(VoiceTest.this);
		findViewById(R.id.ise_cancel).setOnClickListener(VoiceTest.this);
				
		mToast = Toast.makeText(VoiceTest.this, "", Toast.LENGTH_LONG);
	}
