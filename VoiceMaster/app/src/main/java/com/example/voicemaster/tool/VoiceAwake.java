...
public class VoiceAwake extends Activity implements OnClickListener {
	...
	private String getResource() {
		final String resPath = ResourceUtil.generateResourcePath(VoiceAwake.this, RESOURCE_TYPE.assets, "ivw/"+getString(R.string.app_id)+".jet");
