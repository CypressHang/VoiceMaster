 ...
 * 
 */
package com.example.voicemaster.result.xml;

import android.text.TextUtils;
import android.util.Xml;

import com.example.voicemaster.result.FinalResult;
import com.example.voicemaster.result.ReadSentenceResult;
import com.example.voicemaster.result.ReadSyllableResult;
import com.example.voicemaster.result.ReadWordResult;
import com.example.voicemaster.result.Result;
import com.example.voicemaster.result.entity.Phone;
import com.example.voicemaster.result.entity.Sentence;
import com.example.voicemaster.result.entity.Syll;
import com.example.voicemaster.result.entity.Word;
