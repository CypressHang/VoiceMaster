...
import com.example.voicemaster.speech.setting.TtsSettings;
...
public class VoiceRead extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 初始化合成对象
		mTts = SpeechSynthesizer.createSynthesizer(VoiceRead.this, mTtsInitListener);
	...
	private void initLayout() {
		findViewById(R.id.tts_play).setOnClickListener(VoiceRead.this);
		findViewById(R.id.tts_cancel).setOnClickListener(VoiceRead.this);
		findViewById(R.id.tts_pause).setOnClickListener(VoiceRead.this);
		findViewById(R.id.tts_resume).setOnClickListener(VoiceRead.this);
		findViewById(R.id.image_tts_set).setOnClickListener(VoiceRead.this);
		findViewById(R.id.tts_btn_person_select).setOnClickListener(VoiceRead.this);
	...
	public void onClick(View view) {
		...
		case R.id.image_tts_set:
			if(SpeechConstant.TYPE_CLOUD.equals(mEngineType)){
				Intent intent = new Intent(VoiceRead.this, TtsSettings.class);
